...
<html lang="en">
  ...
  <body>
  	...
  	<div class="logo-div" oncontextmenu="return false">
  		<img src="<?=project_url('/assets/images/logo/logo-for-image-search.png');?>" width="100%">
  	</div>
  	
  	<form action="search" method="get">
  		<div class="search-bar-div">
  			<div class="input-box-div">
  				<input type="text" name="q" class="input-box" placeholder="Which image do you want...">
  			</div>
